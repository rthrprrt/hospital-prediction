...
class HospitalPredictionModel:
    ...
    def predict_future(self, last_data, days=30):
        ...
        last_data = pd.DataFrame(last_data) if not isinstance(last_data, pd.DataFrame) else last_data
        ...
        for i in range(1, days + 1):
            ...
            X_future = pd.DataFrame([{
                ...
                'dayOfWeek': new_entry['dayOfWeek'],
                'isWeekend': new_entry['isWeekend'],
                'isSummer': new_entry['isSummer'],
                'isWinter': new_entry['isWinter'],
                'isSpring': new_entry['isSpring'],
                'isFall': new_entry['isFall'],
                'occupancyLag1': new_entry['occupancyLag1'],
                'occupancyLag3': new_entry['occupancyLag3'],
                'occupancyLag7': new_entry['occupancyLag7'],
                'admissionsLag1': new_entry['admissionsLag1'],
                'admissionsLag3': new_entry['admissionsLag3'],
                'admissionsLag7': new_entry['admissionsLag7'],
                'admissionsMA7': new_entry['admissionsMA7'],
                'occupancyMA7': new_entry['occupancyMA7']
            }])
